...
if(localStorage.getItem('arrayCart') !== null){
  ...
  function renderCart(){   
      ...
      let out = `
      <div class="cart-good cart-good${cartGoodId}" attr-id="${cartGoodId}"> 
      <button class="cart-good-del" id="${cartGoodId}" title="Удалить из корзины">&#10006;</button>
      <span class="cart-status-order">${statusOrder}</span>
  ...
  // Validation order
      ...
      function setSuccessFor(input) {
          ...
          if(formCount >= 6){
              ...
              document.getElementById('send-order').innerText = "Заказ отправлен"
