...
$txt .= <<<TEXT
<b><u>Данные для доставки</u></b>%0A<b>Имя</b>: {$userData['usernameValue']}%0A<b>Телефон</b>: {$userData['phoneValue']}%0A<b>Адресс</b>: {$userData['postValue']}%0A<b>№ Отделения</b>: {$userData['adressValue']}%0A<u>{$userData['commentValue']}</u>%0A <b>Итого: {$userData['goodsCost']} грн</b>%0A%0A
TEXT;
}
